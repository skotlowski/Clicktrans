class positive_tests:
    company_name = ['Kimpton Hotels & Restaurants', 'W. L. Gore & Associates', 'Grupa Helion SA', 'Helios S.A',
                    "Jan Kowalski221"]
...
class negative_tests_password_companyname:
    ...
    name_surname = ['Any Name', 'Alex Alex', 'Finlay McGraw', 'Jarret Roberts', 'Makena Woods']
    phone_number = ['435654234', '000000000', '987312476', '543765321', '765432358']
    password = ['Kimpton Hotels & Restaurants', 'W. L. Gore & Associates', 'Grupa Helion SA', 'Helios S.A',
                "Jan Kowalski221"]
